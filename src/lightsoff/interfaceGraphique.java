...
public class interfaceGraphique extends javax.swing.JFrame {
    ...
    public interfaceGraphique() {
        ...
        for(int i=4;i>=0;i--){
            for(int j=0;j<5;j++){
                CelluleGraphique cellGraph= new CelluleGraphique(plateauDeJeu.GrilleDeJeu[i][j]);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panneau_grille, javax.swing.GroupLayout.DEFAULT_SIZE, 480, Short.MAX_VALUE)
                .addContainerGap())
        );
